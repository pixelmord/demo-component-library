...
module.exports = {
  ...
  theme: {
    ...
    typography: (theme) => ({
      ...
      DEFAULT: {
        css: {
          '--tw-prose-body': theme('colors.base.600'),
          ...
          '--tw-prose-counters': theme('colors.base.900'),
          '--tw-prose-bullets': theme('colors.base.900'),
          '--tw-prose-hr': theme('colors.base.100'),
          '--tw-prose-quote-borders': theme('colors.base.200'),
          '--tw-prose-captions': theme('colors.base.400'),
          '--tw-prose-code': theme('colors.base.700'),
          '--tw-prose-code-bg': theme('colors.base.300 / 0.2'),
          ...
          '--tw-prose-invert-hr': theme('colors.base.700 / 0.4'),
          '--tw-prose-invert-quote-borders': theme('colors.base.500'),
          '--tw-prose-invert-captions': theme('colors.base.500'),
          '--tw-prose-invert-code': theme('colors.base.300'),
          '--tw-prose-invert-code-bg': theme('colors.base.200 / 0.05'),
          '--tw-prose-invert-pre-code': theme('colors.base.100'),
          '--tw-prose-invert-pre-bg': 'rgb(0 0 0 / 0.4)',
          '--tw-prose-invert-pre-border': theme('colors.base.200 / 0.1'),
